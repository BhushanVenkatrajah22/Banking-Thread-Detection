...
async function main() {
  ...
  const users = [
    { name: 'Abirami Ganesan', email: 'abirami.ganesan@securemind.bank', password: 'password', role: 'SOC Analyst' },
  ...
  const alerts = [
    { title: 'CRITICAL: Data Exfiltration Risk', description: 'Karthikeyan Balaji behavior drift is 78% (USB insertion detected).', severity: 'high', time: '2 mins ago', unread: true },
