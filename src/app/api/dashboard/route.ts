...
export async function GET() {
  try {
    ...
    // 3. Fetch risk brackets count (0-20, 21-40, etc.)
    ...
    // Match times dynamically relative to now (like "5 mins ago", "1 hour ago", etc.)
    ...
    // 5. Active predictions summaries
